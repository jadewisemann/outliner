...
- 현재 개발 우선순위와 Stage/Phase 상태: [development-plan/index.md](./development-plan/index.md)
...
1. [development-plan/index.md](./development-plan/index.md)에서 현재 최우선 Stage와 Phase를 확인한다.
